package webService3
{
	...
	public class WebEvent3 extends Event
	{
		...
		public function WebEvent3(type:String,pureString:Array=null,myToken:AsyncToken=null,ConnectionProblemCode:uint = error_connection_problem,ProblemHint:String='')
		{
			pureData = pureString ;
		...
		{
			var newEvent:WebEvent3 = new WebEvent3(type,pureData,token,connectionProblemCode,problemHint);
			return newEvent ;
		}
	}
}